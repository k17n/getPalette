...
const GetPaletteButton = () => {
    return(
       <div>
            <div className="d-flex flex-column flex-sm-row justify-content-center align-items-center my-4">
                <button type="button" class="get-palette-btn btn btn-primary mx-5 my-3">Get your Palette</button>
            </div>
            <div className="d-flex flex-column flex-sm-row justify-content-center align-items-center my-4">
